...
class RandomColorGUI:
    def __init__(self):
        ...
        quit = Button(self.mainWindow, text="Quit", command=self.quit)
        quit.grid(row=5, column=3, padx=20, pady=10)
        color = Button(self.mainWindow, text="Change Color", command=self.changeColor)
        color.grid(row=2, column=3, padx=20, pady=10)
    ...
    def changeColor(self):
        """Generates three integers between 0 and 255. It then calls the makeColorString method
        with these integers as parameters and sets the background color of the window to the return
        value of the makeColorString method"""
        self.r = random.randint(0, 255)
        self.g = random.randint(0, 255)
        self.b = random.randint(0, 255)
        self.mainWindow["bg"] = (self.makeColorString(self.r, self.g, self.b))
...
# A function that is an an attribute of a class or an instance is called a method.
